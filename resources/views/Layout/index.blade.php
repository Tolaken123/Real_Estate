  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav nav-pills nav-justified me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Commercial</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Areas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Resources</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="javascript:void(0)">Hot Properties!!</a>
        </li>
        <li class="nav-item">
