...
<body id="home">
            ...
            <ul class="nav justify-content-end">
                <li class="nav-item">
                    <a class="nav-link active" href="#">
                        <h5 class="text-white text-capitalize">Properties</h5>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <h5 class=" text-white text-capitalize">Rent</h5>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <h5 class=" text-white text-capitalize">Sale</h5>
                    </a>
                </li>
                ...
                @if (Route::has('login'))
                    ...
                    @auth
                        <a class="text-decoration-none" href="{{ url('/home') }}">
                            <h5 class=" text-white text-capitalize">Dashboard</h5>
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="nav-link">
                            <h5 class="text-white text-capitalize">Login</h5>
                        </a>
                        ...
                        <li class="nav-item">
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="nav-link">
                                    <h5 class=" text-white text-capitalize">Register</h5>
                                </a>
                            @endif
                        @endauth
                        <!-- {{-- </div> --}} -->
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img alt="..." class="d-block w-100"
                    src="https://live.staticflickr.com/7442/15787257743_1b50713c53_b.jpg">
                <div class="carousel-caption">
                    <h5 class="animated bounceInRight" style="animation-delay: 1s">RealEstate</h5>
                    <p class="animated bounceInLeft d-none d-md-block" style="animation-delay: 2s">The world Properties
                        are in your hand.</p>
            ...
            <div class="carousel-item">
                <img alt="..." class="d-block w-100"
                    src="https://live.staticflickr.com/8596/16295589400_ae836d00ea_b.jpg">
                <div class="carousel-caption">
                    <h5 class="animated bounceInRight" style="animation-delay: 1s">Properties Sale</h5>
                    <p class="animated bounceInLeft d-none d-md-block" style="animation-delay: 2s">Find many properties
                        to buy.</p>
                    <p class="animated bounceInRight" style="animation-delay: 3s"><a href="#">Learn More</a></p>
                </div>
            </div>
            <div class="carousel-item">
                <img alt="..." class="d-block w-100"
                    src="https://live.staticflickr.com/7419/16218918228_93ab6aa2e9_b.jpg">
                <div class="carousel-caption">
                    <h5 class="animated bounceInRight" style="animation-delay: 1s">Properties Rent</h5>
                    <p class="animated bounceInLeft d-none d-md-block" style="animation-delay: 2s">Thare are many
                        Properties for rent.</p>
                    <p class="animated bounceInRight" style="animation-delay: 3s"><a href="#">Learn More</a>
                    </p>
                </div>
            </div>
  ...
  <a href="#" class="w3-bar-item w3-button">Link 3</a>
    ...
    <div class="row jumbotron m-5">
        <div class="text-center mb-4 "><strong class="btn btn-primary fs-4" style="background: #140B5C;"
                id="sale">Properties For Sale</strong></div>
        <!-- item -->
            ...
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        ...
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/duongprofile (2).jpg" width="50px" height="50px">
                        <div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/daraprofile.jpg" width="50px" height="50px">
                        <div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/tolaprofile.jpg" width="50px" height="50px">
                        <div>
    ...
    <div class="row jumbotron m-5">
        ...
        <div class="text-center mb-4 "><strong class="btn btn-primary fs-4" style="background: #140B5C;"
                id="rent">Properties For Rent</strong></div>
        <!-- item -->
        <div class="col-lg-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/tharothprofile.jpg" width="50px" height="50px">
                        <div>
            ...
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        <!-- <a href="javascript:void(10) " class="m-r-15"> --></a>
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/heyprofile.jpg" width="50px" height="50px">
                        <div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/lyhorngprofile.jpg" width="50px" height="50px">
                        <div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body border-top">
                    <div class="d-flex no-block align-items-center">
                        <img alt="img " class="rounded-circle border border-5 border-white "
                            src="../img/user2-160x160.jpg" width="50px" height="50px">
                        <div>
        ...
        <footer>
            ...
            <div class="bottom-details">
                <div class="bottom_text">
                    <span class="copyright_text">Copyright &#169; 2022 <a href="#">Cam RealEstate</a>All rights
                        reserved</span>
